    ...
    <body>
            ...
            <nav>
                <?php
                    if($log) {
                        ...
                        echo "<a id='demo' href='homepage.php'>Demo</a>
        ...
        <section class="center">
            <div id="first" class="card">
                <h1>Take the Demo</h1>
                <p>Part 1: Take the skills questionnaire to find your top three opportunities in the freelance economy</p>
                <p>Part 2: Try the rideshare optimization tools</p>
                <p>Part 3: Use the scheduler to estimate income</p>
                <br/>
                <br/>
                <div class="buttons">
                    <button id="firstButton" class="btn btn-primary">Demo</button>
                </div>
            </div>
            <div id="second" class="card">
                ...
                <div class="left">
                    ...
                    <br/>
                    <strong>*This filter only eliminates the most obvious contact-based opportunities (like massage therapy)
                ...
                <br/>
                <div class="buttons">
                    <button id="secondButtonBack" class="btn btn-danger">Back</button>
                    <button id="secondButtonNext" class="btn btn-primary">Next</button>
                </div>
            </div>
            <div id="third" class="card">
                ...
                <div id="specificLanguage" class="specificSkills">
                    ...
                    <div class="left">
                        ...
                        <br/>
                        <!-- Translate -->
                        <input id="Translate" type="checkbox" name="writing[]" value="Translate"/> Translation
                        <br/>
                        <!-- Italki -->
                ...
                <br/>
                <div class="buttons">
                    <button id="thirdButtonBack" class="btn btn-danger">Back</button>
                    <button id="thirdButtonNext" class="btn btn-primary">Next</button>
                </div>
            </div>
            <div id="fourth" class="card">
                ...
                <br/>
                <div class="buttons">
                    <button id="fourthButtonBack" class="btn btn-danger">Back</button>
                    <button id="fourthButtonNext" class="btn btn-primary">Next</button>
                </div>
            </div>
            <div id="fifth" class="card">
                <h2>Results</h2>
                <p>Here are your top three opportunities. <a href="signUp.php">Sign up</a> to see the full list of recommendations!</p>
                ...
                <div id="foodDeliveryCards">
                    ...
                    <div class="card questionnaire gig GrubhubCard">
                        ...
                        <?php
                            if(!Database::query("SELECT gig FROM gigs WHERE userId=:userId AND gig=:gig", array(":userId"=>$userId, ":gig"=>"Grubhub"))) {
                                $btn = "btn-primary";
                                $text = "Add";
                            } else {
                                $btn = "btn-danger";
                ...
                <br/>
                <div class="buttons">
                    <button id="fifthButtonBack" class="btn btn-danger">Back</button>
                    <button id="fifthButtonNext" class="btn btn-primary">Next</button>
                </div>
            </div>
            <div id="sixth" class="card">
                <h1>Rideshare Graphs</h1>
                <p><a href="signUp.php">Sign up</a> to request your city and state and we'll make graphs like the following for you so you can optimize your rideshare runs</p>  
                ...
                <br/>
                <div class="buttons">
                    <button id="sixthButtonBack" class="btn btn-danger">Back</button>
                    <button id="sixthButtonNext" class="btn btn-primary">Next</button>
                </div>
            </div>
            <div id="seventh" class="card">
                <h1>Rideshare Demo</h1>
                <p>Learn which rideshare platform you can earn more on in the next hour</p>
                <input id="address" type="text" name="address" placeholder="Enter location address" required/>
                <br/>
                <div class="buttons">
                    <input id="eval" class="btn btn-success" type="button" value="Evaluate" onclick="find()"/>
                </div>
                <p id="status"></p>
                <p>Uber: <span id="result1"></span></p>
                <p>Lyft: <span id="result2"></span></p>
                <br/>
                <br/>
                <div class="buttons">
                    <button id="seventhButtonBack" class="btn btn-danger">Back</button>
                    <button id="seventhButtonNext" class="btn btn-primary">Next</button>
                </div>
            </div>
            <div id="eighth" class="card">
                <h1>Schedule Demo</h1>
                <p>Estimate how much you can make this week*</p>
                <small>*The hourly wages depend on location and time; the more feedback and users we get, the more accurate these estimates will be</small>
                <p><a href="signUp.php">Sign up</a> to request your city and state and we'll get back to you as soon as possible</p>
                <select>
                    <option value="maryland">Maryland</option>
                </select>
                <br/>
                <div class="scheduleGigs">
                    <button id="firstPlatform" class="gigs btn btn-primary">Uber</button>
                    <button id="secondPlatform" class="gigs btn btn-secondary">Lyft</button>
                    <button id="thirdPlatform" class="gigs btn btn-success">Uber Eats</button>
                    <button id="fourthPlatform" class="gigs btn btn-danger">DoorDash</button>
                    <button id="fifthPlatform" class="gigs btn btn-warning">Postmates</button>
                    <button id="sixthPlatform" class="gigs btn btn-info">Grubhub</button>
                </div>
                </br>
                <p id="hours"></p>
                <p id="earnings"></p>
                ...
                <br/>
                <div class="buttons">
                    <button id="eighthButtonBack" class="btn btn-danger">Back</button>
                    <button id="eighthButtonNext" class="btn btn-primary">Next</button>
                </div>
            </div>
            <div id="ninth" class="card">
                <h1>Earn More with Mogle</h1>
                <p>Mogle is still in development! If you'd like tools to manage and optimize your gigs, <a href="signUp.php">sign up</a> and we'll reach out to you with updates over email.</p>
                <br/>
                <h1>Newsletter</h1>
                <p>Enter your email to receive weekly research on three new freelance opportunities and other gig-related news</p>
                <input id="emailNewsletter" type="text"/>
                <br/>
                <div class="buttons">
                ...
                <br/>
                <h1>Survey</h1>
                <p>Help us out by answering this quick, 2-minute <a href="https://docs.google.com/forms/d/e/1FAIpQLSfEmne7QltUJDfvQ4OHsSUjgN_ZAHfd1ZkKPXB2-NmWF8_w2g/viewform" target="_blank">survey</a>.</p>
                <br/>
                <h1>Facebook Page</h1>
                <p>Join the <a href="https://www.facebook.com/Mogle-108396080770227" target="_blank">Facebook page</a> for updates.</p>
                <br/>
                <h1>Feedback</h1>
                <p>Send us feedback! If there's any way we can make your experience better, please email mogleapp@gmail.com with your suggestions.</p>
                <br/>
                <br/>
                <div class="buttons">
                    <button id="ninthButton" class="btn btn-primary">Restart Demo</button>
                </div>
            </div>
        </section>
        <script>
            $(function() {
				$("#demo").css({"background-color": "#800000", "color": "#fff"});
            });
            $(".card").hide();
            $("#first").show();
            ...
            $("#secondButtonNext").click(function() {
                $("#second").hide();
                $("#third").show();
            });
            ...
            $("#thirdButtonNext").click(function() {
                $("#third").hide();
                $("#fourth").show();
            });
            $("#fourthButtonBack").click(function() {
                $("#fourth").hide();
                $("#third").show();
            });
            $("#fourthButtonNext").click(function() {
                $("#fourth").hide();
                $("#fifth").show();
            });
            $("#fifthButtonBack").click(function() {
                $("#fifth").hide();
                $("#fourth").show();
            });
            $("#fifthButtonNext").click(function() {
                $("#fifth").hide();
                $("#sixth").show();
            });
            $("#sixthButtonBack").click(function() {
                $("#sixth").hide();
                $("#fifth").show();
            });
            $("#sixthButtonNext").click(function() {
                $("#sixth").hide();
                $("#seventh").show();
            });
            $("#seventhButtonBack").click(function() {
                $("#seventh").hide();
                $("#sixth").show();
            });
            $("#seventhButtonNext").click(function() {
                $("#seventh").hide();
                $("#eighth").show();
            });
            $("#eighthButtonBack").click(function() {
                $("#eighth").hide();
                $("#seventh").show();
            });
            $("#eighthButtonNext").click(function() {
                $("#eighth").hide();
                $("#ninth").show();
            });
            $("#ninthButton").click(function() {
                window.location.replace("/mogle/homepage.php");
            });
        </script>
        <script src="js/mogle.js"></script>
        <script src="js/demo/questionnaire.js"></script>
        <script src="js/demo/rideshare.js"></script>
        <script src="js/demo/schedule.js"></script>
        <script src="js/demo/newsletter.js"></script>
    </body>
</html>